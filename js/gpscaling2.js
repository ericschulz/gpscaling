...
var ntrials = 200,//number of trials
    ...
    timetotal=0,
    correcttotal=0,
    letter='<input type="image" src="pngs2/func',//the letter
...
//Experiment
////////////////////////////////////////////////////////////////////////
var inpinit='<input type="image" src="pngs2/init.png"  width="400" height="400">'
var inpbegin='<input type="image" src="pngs2/begin.png"  width="400" height="400">'
var inpcor='<input type="image" src="pngs2/correct.png"  width="400" height="400">'
var inpwro='<input type="image" src="pngs2/incorrect.png"  width="400" height="400">'
...
{
  drawpattern(target);
  var fingpos='<input type="image" src="pngs2/op.png"  width="400" height="100">'
